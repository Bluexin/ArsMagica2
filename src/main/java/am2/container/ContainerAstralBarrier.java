...
public class ContainerAstralBarrier extends AM2Container{
	...
	public ContainerAstralBarrier(InventoryPlayer inventoryplayer, TileEntityAstralBarrier receptacle){
		...
		addSlotToContainer(new SlotGhostRune(receptacle, 1, 62, 8)); //inventory, index, x, y
		addSlotToContainer(new SlotGhostRune(receptacle, 2, 80, 8)); //inventory, index, x, y
		addSlotToContainer(new SlotGhostRune(receptacle, 3, 98, 8)); //inventory, index, x, y
